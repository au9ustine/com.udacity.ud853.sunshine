...
public class TestProvider extends AndroidTestCase {
    ...
    public static String TEST_DATE = "20150213";

    static public ContentValues createNorthPoleLocationValues() {

        ContentValues testValues = new ContentValues();
        testValues.put(LocationEntry.COLUMN_LOCATION_SETTING, TEST_CITY_NAME);
